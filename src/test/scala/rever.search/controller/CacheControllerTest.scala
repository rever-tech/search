package rever.search.controller
...
import rever.search.Server
import rever.search.domain.UserID
import rever.search.domain.thrift.{TUserID, TUserInfo}
import rever.search.service.TUserCacheService.FinagledClient
